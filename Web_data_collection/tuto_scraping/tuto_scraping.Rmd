...
- bla bla Webscraping sauce sauvage
- bla bla Webscraping avec API

# Ethics, some elements of reflexion.

In two words : 

- Grey Zone ! Heavily dependent of your country.  
- Text not so clear, but RGPD include **derogations** for researchers
- Contact CNIL (France) or similar institute in your country

In more than two words, a document writed for this school :
...
- Advanced :
    - use User-Agent
    - use the OCR / IA 
    - use Proxy/VPN or TOR
    - use cookie/js injection
    - use headless browsers 
    - use a framework (=> Scrapy !)
    - use a framework + headless browser
