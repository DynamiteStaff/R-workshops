...
torontonAirbnb <- read.csv(paste0('insideairbnb/', f[2]))
vancouverAirbnb <- read.csv(paste0('insideairbnb/', f[3]))

df <-  rbind(montrealAirbnb, torontonAirbnb, vancouverAirbnb)
```
...
```{r applyCensusDiversityFunctions}
...
```{r applyCensusSegregationFunctions}
...
```{r vizAibnbMinoritiesAndDistance}
