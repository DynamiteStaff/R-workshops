...
ReardonSegregationAirbnbPrice = segIndex10(tabOfSpatialUnits = toronto_tracts@data, distributionColNames = paste0("G", 1:10))
...
EntropySegregationMinorities = cma_seg[cma_seg$`Region Name` == "Toronto (C)","H"]
